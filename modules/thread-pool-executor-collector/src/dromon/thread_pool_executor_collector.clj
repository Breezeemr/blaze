(ns dromon.thread-pool-executor-collector
  (:require
...
(defmethod ig/init-key :dromon/thread-pool-executor-collector
  [_ {:keys [executors]}]
...
(derive :dromon/thread-pool-executor-collector :dromon.metrics/collector)
