...
(defmethod ig/pre-init-spec :dromon.terminology-service/extern [_]
  (s/keys
    :req-un
    [::uri]
    :opt-un
...
(defmethod ig/init-key :dromon.terminology-service/extern
  [_
   {:keys
    [uri
     proxy-host
...
(derive :dromon.terminology-service/extern :dromon/terminology-service)
