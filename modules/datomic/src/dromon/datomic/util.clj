(ns dromon.datomic.util
  (:require [clojure.spec.alpha :as s]
            [datomic-spec.core :as ds]
            [datomic.api :as d]
            dromon.datomic.search-parameter)
...
(s/fdef list-resources-sorted-by
  :args (s/cat :db ::ds/db :type string? :search-param :dromon/search-parameter)
  :ret (s/coll-of ::ds/entity))
...
(s/fdef find-search-param-by-type-and-code
  ...
  :ret (s/nilable :dromon/search-parameter))
