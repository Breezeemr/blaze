(ns dromon.cql-translator
  ...
  (:import javax.xml.bind.JAXB
           [org.cqframework.cql.cql2elm CqlTranslator CqlTranslator$Options FhirLibrarySourceProvider LibraryManager ModelInfoLoader ModelInfoProvider ModelManager]
...
(load-model-info "dromon/fhir-modelinfo-4.0.0.xml")
