(ns dromon.structure-definition
  (:require
...
(defn read-structure-definitions []
  (let [package "dromon/fhir/r4/structure_definitions"]
    (into
...
(defn read-search-parameters []
  (into
    []
    (map :resource)
    (:entry (read-bundle "dromon/fhir/r4/search-parameters.json"))))


(defmethod ig/init-key :dromon/structure-definition
  [_ _]
...
(defmethod ig/init-key :dromon/search-parameter
  [_ _]
